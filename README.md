...
## Requirements Checklist
    1. Get username and display corresponding user details and repositories as shown in the screenshot above
        - Show the error message with a big warning icon e.g. if not username is not found (done)
        - If user is found, show information for user and for each repo as shown in the screenshot(done)
        - Test and record screencast for usernames torvalds, Rich-Harris, JakeWharton, and newtoneinstein. (You can show yours too!)(done)
    2. Extend the same functionality for organizations:
        - Add a radio button to select username or orgname(done)
    ...
    3. Bonus Points:
        - Design Similarity E.g. colors, fonts, dark mode, etc. ( I tried)
        - Use short number format e.g. 42200 as 42.2k (done)
